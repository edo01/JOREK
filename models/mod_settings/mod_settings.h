/* models/mod_settings/mod_settings.h -- the array extents of models/mod_settings.f90.
 *
 ...
 */
#ifndef JOREK_MOD_SETTINGS_H
#define JOREK_MOD_SETTINGS_H
