...
integer, parameter :: n_plane           = 12      !< number of toroidal angles
integer, parameter :: n_order           = 3      !< order of the polynomial basis
integer, parameter :: n_nodes_max       = 90001  !< maximum number of nodes
integer, parameter :: n_elements_max    = 90001  !< maximum number of elements
integer, parameter :: n_boundary_max    = 9009   !< maximum number of boundary elements
integer, parameter :: n_pieces_max      = 9001   !< maximum number of line pieces describing a flux surface
