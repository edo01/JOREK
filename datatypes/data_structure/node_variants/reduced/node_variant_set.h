/* node_variants/reduced/node_variant_set.h -- the node set of a reduced-MHD model.
 *
...
using node_model_set = node_set<L, Real, Int>;
...
inline node_model_set_aos node_model_set_from_registry(void* base,
                                                       std::size_t n_nodes) {
  return node_set_from_registry(base, n_nodes);
}
